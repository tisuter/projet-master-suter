...
let motsCiblesFilmBVar2 = [
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'fou', audio: 'sound/mots-cibles/01-fou.m4a', sentence: '<p>Maintenant, dans les boîtes de Weetabix, y en a 16. Avant, il y en avait genre 32, parfois même 34. C’est <b>fou</b>, non ?</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'amoureuse', audio: 'sound/mots-cibles/01-amoureuse.m4a', sentence: '<p>On n\'est pas dans Pretty Woman. Elle va pas tomber <b>amoureuse</b> "d\'un" pute.</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'dégueulasse', audio: 'sound/mots-cibles/01-degueulasse.m4a', sentence: '<p>Elle a pas assez morflé avec Max ? Mais c\'est <b>dégueulasse</b>. Je suis négligée, je suis <b>dégueulasse</b>. Même propre, je fais sale.</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'd’ailleurs', audio: 'sound/mots-cibles/01-ailleurs.m4a', sentence: '<p><b>D\'ailleurs</b>, chéri, t\'aurais pas 200 euros à me prêter ?</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'parfois', audio: 'sound/mots-cibles/01-parfois.m4a', sentence: '<p>Maintenant, dans les boîtes de Weetabix, y en a 16. Avant, il y en avait genre 32, <b>parfois</b> même 34</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'dehors', audio: 'sound/mots-cibles/01-dehors.m4a', sentence: '<p>Vous allez pas les foutre <b>dehors</b> quand même ?</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'franchement', audio: 'sound/mots-cibles/01-franchement.m4a', sentence: '<p><b>Franchement</b>, tu l\'as trouvée comment ? Elle est chou, non ?</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'sinon', audio: 'sound/mots-cibles/01-sinon.m4a', sentence: '<p>Je compte sur toi pour régler ça, <b>sinon</b> le panier, c\'est pour moi.</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'genre', audio: 'sound/mots-cibles/01-genre.m4a', sentence: '<p>Lui, c\'est le mec, <b>genre</b> à dire : "Bon appétit !"</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'avant', audio: 'sound/mots-cibles/01-avant.m4a', sentence: '<p>Genre, là, tout de suite, maintenant, <b>avant</b> 18h30 ?</p>'},

    {category: "TW", type: 'nomPl', translation: shuffle([...b1NomPl]), text: 'des clés', audio: 'sound/mots-cibles/01-cles.m4a', sentence: '<p>Ça suffit de mettre tes <b>clés</b> là, on va se faire cambrioler.</p>'},
    ...
    {category: "TW", type: 'verbesIndef', translation: shuffle([...b1VerbesIndef]), text: 'payé', audio: 'sound/mots-cibles/01-paye.m4a', sentence: '<p>J\'ai <b>payé</b> que pour deux rendez-vous. Ça va la décoincer et basta.</p>'},
    {category: "TW", type: 'verbesIndef', translation: shuffle([...b1VerbesIndef]), text: 'refusée', audio: 'sound/mots-cibles/01-refusee.m4a', sentence: '<p>Ta carte a été <b>refusée</b>.</p>'},
...
let motsCiblesFilmCVar2 = [
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'flou', audio: 'sound/mots-cibles/02-flou.m4a', sentence: '<p>Pourquoi j\'arrive pas à rester propre comme toutes ces filles avec leur petit carré <b>flou</b> parfait, leur petit slim noir sans plis...</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'ultime', audio: 'sound/mots-cibles/02-ultime.m4a', sentence: '<p>C\'est ma passion <b>ultime</b>, les boulettes !</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'sale', audio: 'sound/mots-cibles/02-sale.m4a', sentence: '<p>Je suis négligée, je suis dégueulasse. Même propre, je fais <b>sale</b>.</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'encore', audio: 'sound/mots-cibles/02-encore.m4a', sentence: '<p>Antoine croit <b>encore </b>que tu vas au yoga prénatal ?</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'jamais', audio: 'sound/mots-cibles/02-jamais.m4a', sentence: '<p>Ce sera <b>jamais </b>fini avant l\'arrivée du bébé.</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'car', audio: 'sound/mots-cibles/02-car.m4a', sentence: '<p>Et t\'attends pas à un cadeau commun <b>car </b>personne a mis sur la cagnotte</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'si', audio: 'sound/mots-cibles/02-si.m4a', sentence: '<p>T\'es <b>si </b>jolie que j\'en oublie que ton pull est dégueulasse.</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'sauf', audio: 'sound/mots-cibles/02-sauf.m4a', sentence: '<p>- Non, mais... je vois tout <b>sauf</b> quelqu\'un de bidon, moi.</p><p>- T\'es magnifique.</p>'},

    {category: "TW", type: 'nomPl', translation: shuffle([...c1NomPl]), text: 'des boulettes', audio: 'sound/mots-cibles/02-boulettes.m4a', sentence: '<p>Des sandwichs <b>aux boulettes</b> ? </p><p>– Oui.</p>'},
    {category: "TW", type: 'nomPl', translation: shuffle([...c1NomPl]), text: 'des conneries', audio: 'sound/mots-cibles/02-conneries.m4a', sentence: '<p>- Je comprends rien au texto. Tiens.</p><p>- Envoie pas <b>de conneries</b>. </p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...c1NomSg]), text: 'un endroit', audio: 'sound/mots-cibles/02-endroit.m4a', sentence: '<p>On a pas <b>d\'endroit</b> pour faire ton anniversaire.</p>'},

    {category: "TW", type: 'nomSg', translation: shuffle([...c1NomSg]), text: 'une goutte', audio: 'sound/mots-cibles/02-goutte.m4a', sentence: '<p>- Vas-y, la petite touche pro : maïs, donut, <b>goutte</b>, <b>goutte</b>. Terminé.</p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...c1NomSg]), text: 'une crotte', audio: 'sound/mots-cibles/02-crotte.m4a', sentence: '<p>- Il m\'a répondu !</p><p>- Ça dit quoi ? </p><p>- Alien, alien, <b>crotte</b>, bébé.</p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...c1NomSg]), text: 'un pote', audio: 'sound/mots-cibles/02-pote.m4a', sentence: '<p>C\'est la <b>pote </b>d\'Elsa qui me l\'a filé pour être dans le perso.</p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...c1NomSg]), text: 'une confiance', audio: 'sound/mots-cibles/02-confiance.m4a', sentence: '<p>- C\'est une surprise ?</p><p>- T\'as <b>confiance</b> en moi?</p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...c1NomSg]), text: 'un truc', audio: 'sound/mots-cibles/02-truc.m4a', sentence: '<p>Vous me cachez <b>un truc</b> ou quoi ?</p>'},

    {category: "TW", type: 'verbesIndef', translation: shuffle([...c1VerbesIndef]), text: 'j’avoue', audio: 'sound/mots-cibles/02-avoue.m4a', sentence: '<p>Bon, OK, <b>j\'avoue</b>. Je venais ici, petit.</p>'},
    {category: "TW", type: 'verbesIndef', translation: shuffle([...c1VerbesIndef]), text: 'tu crois', audio: 'sound/mots-cibles/02-crois.m4a', sentence: '<p>- Et le père Noël, c\'est pour dire que t\'es un cadeau du ciel.</p><p>- <b>Tu crois </b>? </p>'},
    {category: "TW", type: 'verbesIndef', translation: shuffle([...c1VerbesIndef]), text: 't’inquiète', audio: 'sound/mots-cibles/02-inquiete.m4a', sentence: '<p>- Tu m\'en veux pas, hein ? </p><p>- Non, <b>t\'inquiète</b>.</p>'},
    {category: "TW", type: 'verbesIndef', translation: shuffle([...c1VerbesIndef]), text: 'vous cachez', audio: 'sound/mots-cibles/02-cachez.m4a', sentence: '<p>- Qu\'est-ce qui se passe ? Vous êtes trop cheloues ce soir.</p><p>- Vous me <b>cachez</b> un truc ou quoi ?</p>'},
    {category: "TW", type: 'verbesIndef', translation: shuffle([...c1VerbesIndef]), text: 'on s’en fout', audio: 'sound/mots-cibles/02-fout.m4a', sentence: '<p><b>On s\'en fout</b> ! Réponds. Sinon, ça fait la meuf qui attend pour répondre.</p>'},

    {category: "TW", type: 'verbesConjug', translation: shuffle([...c1VerbesConjug]), text: 'mentir', audio: 'sound/mots-cibles/02-mentir.m4a', sentence: '<p>C\'est pour savoir si je dois continuer <b>mentir</b> à mon frère sur ton congé.</p>'},
    {category: "TW", type: 'verbesConjug', translation: shuffle([...c1VerbesConjug]), text: 'envoie', audio: 'sound/mots-cibles/02-envoie.m4a', sentence: '<p><b>Envoie</b> juste un texto.</p>'},
    {category: "TW", type: 'verbesConjug', translation: shuffle([...c1VerbesConjug]), text: 'transfère', audio: 'sound/mots-cibles/02-transfere.m4a', sentence: '<p>- Vas-y, la petite touche pro : maïs, donut, goutte, goutte. Terminé. <b>Transfère</b>.</p><p>- Il m\'a répondu !</p>'},
    {category: "TW", type: 'verbesConjug', translation: shuffle([...c1VerbesConjug]), text: 'tué', audio: 'sound/mots-cibles/02-tue.m4a', sentence: '<p>Le gars qui a <b>tué</b> cette fille rencontrée sur Tinder.  </p>'},
];
...
let motsCiblesFilmDVar2 = [
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'sérieux', audio: 'sound/mots-cibles/03-serieux.m4a', sentence: '<p>C\'est <b>sérieux</b> avec son nouveau mec ?</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'curieuse', audio: 'sound/mots-cibles/03-curieuse.m4a', sentence: '<p>« Passionnément <b>curieuse</b>.» Non, mais la fausse vie. Brangelina de la lose.</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'chiante', audio: 'sound/mots-cibles/03-chiante.m4a', sentence: '<p>Pardon, les meufs. Je suis tellement <b>chiante</b>.</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'prête', audio: 'sound/mots-cibles/03-prete.m4a', sentence: '<p>Moi, à ce train-là, je suis pas <b>prête</b> d\'avoir des petits-enfants.</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'maintenant', audio: 'sound/mots-cibles/03-maintenant.m4a', sentence: '<p>Elle attend la réponse du pute. On fait quoi, <b>maintenant</b> ?</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'tellement', audio: 'sound/mots-cibles/03-tellement.m4a', sentence: '<p>Je comprends pas. Mon plan était <b>tellement</b> ingénieusement génial.</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'rien', audio: 'sound/mots-cibles/03-rien.m4a', sentence: '<p>- Ça va pas ?</p><p>- Juste une merde au boulot, <b>rien</b> de...</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'mais', audio: 'sound/mots-cibles/03-mais.m4a', sentence: '<p>- Physiquement ?</p><p>- Non, <b>mais</b> aussi au niveau caractère.</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'avec', audio: 'sound/mots-cibles/03-avec.m4a', sentence: '<p>- Du codo quoi ?</p><p>- Ben, du cododo. Dormir <b>avec</b> le bébé.</p>' },

    {category: "TW", type: 'nomPl', translation: shuffle([...d1NomPl]), text: 'une poussette', audio: 'sound/mots-cibles/03-poussette.m4a', sentence: '<p>Et merci pour la <b>poussette</b> !</p>' },
    {category: "TW", type: 'nomPl', translation: shuffle([...d1NomPl]), text: 'une plaie', audio: 'sound/mots-cibles/03-plaie.m4a', sentence: '<p>Quelle <b>plaie</b>.</p>' },
    {category: "TW", type: 'nomPl', translation: shuffle([...d1NomPl]), text: 'un taf', audio: 'sound/mots-cibles/03-taf.m4a', sentence: '<p>Je vais au <b>taf</b>. </p>' },
    {category: "TW", type: 'nomPl', translation: shuffle([...d1NomPl]), text: 'un cadeau', audio: 'sound/mots-cibles/03-cadeau.m4a', sentence: '<p><b>Cadeau</b> des parrains. Ça se fait, non ?</p>' },
    {category: "TW", type: 'nomPl', translation: shuffle([...d1NomPl]), text: 'une robe', audio: 'sound/mots-cibles/03-robe.m4a', sentence: '<p>Je vais payer pour la <b>robe</b> et pour son haut aussi.</p>' },
    {category: "TW", type: 'nomPl', translation: shuffle([...d1NomPl]), text: 'un boulot', audio: 'sound/mots-cibles/03-boulot.m4a', sentence: '<p>Et, au <b>boulot</b>, eh ben... je me sens complètement inutile.</p>' },

    {category: "TW", type: 'nomSg', translation: shuffle([...d1NomSg]), text: 'des parrains', audio: 'sound/mots-cibles/03-parrains.m4a', sentence: '<p>Cadeau des <b>parrains</b>. Ça se fait, non ?</p>' },
    {category: "TW", type: 'nomSg', translation: shuffle([...d1NomSg]), text: 'des fringues', audio: 'sound/mots-cibles/03-fringues.m4a', sentence: '<p>Bon, vas-y, on y va, je vais te louer des <b>fringues</b>. On va chez moi.</p>' },

    {category: "TW", type: 'verbesIndef', translation: shuffle([...d1VerbesIndef]), text: 'aider', audio: 'sound/mots-cibles/03-aider.m4a', sentence: '<p>Je peux vous <b>aider</b> ?</p>' },

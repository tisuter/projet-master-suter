...
let motsCiblesFilmB = [
    ...
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'amoureuse', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-amoureuse.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-amoureuse.m4a', sentence: '<p>On n\'est pas dans Pretty Woman. Elle va pas tomber <b>amoureuse</b> "d\'un" pute.</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'dégueulasse', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-degueulasse.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-degueulasse.m4a', sentence: '<p>Elle a pas assez morflé avec Max ? Mais c\'est <b>dégueulasse</b>. Je suis négligée, je suis <b>dégueulasse</b>. Même propre, je fais sale.</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'd’ailleurs', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-ailleurs.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-ailleurs.m4a', sentence: '<p><b>D\'ailleurs</b>, chéri, t\'aurais pas 200 euros à me prêter ?</p>'},
    ...
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'dehors', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-dehors.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-dehors.m4a', sentence: '<p>Vous allez pas les foutre <b>dehors</b> quand même ?</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'franchement', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-franchement.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-franchement.m4a', sentence: '<p><b>Franchement</b>, tu l\'as trouvée comment ? Elle est chou, non ?</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'sinon', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-sinon.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-sinon.m4a', sentence: '<p>Je compte sur toi pour régler ça, <b>sinon</b> le panier, c\'est pour moi.</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'genre', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-genre.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-genre.m4a', sentence: '<p>Lui, c\'est le mec, <b>genre</b> à dire : "Bon appétit !"</p>'},
    {category: "TW", type: 'adjectifs&co', translation: shuffle([...b1Adjectifs]), text: 'avant', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-avant.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-avant.m4a', sentence: '<p>Genre, là, tout de suite, maintenant, <b>avant</b> 18h30 ?</p>'},

    {category: "TW", type: 'nomPl', translation: shuffle([...b1NomPl]), text: 'les clés', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-cles.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-cles.m4a', sentence: '<p>Ça suffit de mettre tes <b>clés</b> là, on va se faire cambrioler.</p>'},
    {category: "TW", type: 'nomPl', translation: shuffle([...b1NomPl]), text: 'les courses', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-courses.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-courses.m4a', sentence: '<p>Oui, c\'est la liste de <b>courses</b> de ma meuf.</p>'},
    {category: "TW", type: 'nomPl', translation: shuffle([...b1NomPl]), text: 'les gosses', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-gosses.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-gosses.m4a', sentence: '<p>Et bruncher avec tes potes qui ont des <b>gosses</b>.</p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...b1NomSg]), text: 'la cagnotte', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-cagnotte.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-cagnotte.m4a', sentence: '<p>- C\'est pour l\'anniv d\'Elsa.</p><p>- J\'ai déjà mis sur ta <b>cagnotte</b> Leetchi.</p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...b1NomSg]), text: 'la lourdeur', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-lourdeur.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-lourdeur.m4a', sentence: '<p>- Oh, mais la lourdeur ! Milou !</p><p>- C\'est toi, la <b>lourdeur</b>.</p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...b1NomSg]), text: 'le mec', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-mec.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-mec.m4a', sentence: '<p>C\'était cool de passer un moment avec ce <b>mec</b>.</p>'},

    {category: "TW", type: 'verbesIndef', translation: shuffle([...b1VerbesIndef]), text: 'trouvé', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-trouve.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-trouve.m4a', sentence: '<p>Bien sûr, vous l\'avez <b>trouvé</b>. Où ça ? Dans le sac de Charlotte ?</p>'},
    {category: "TW", type: 'verbesIndef', translation: shuffle([...b1VerbesIndef]), text: 'payé', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-paye.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-paye.m4a', sentence: '<p>J\'ai <b>payé</b> que pour deux rendez-vous. Ça va la décoincer et basta.</p>'},
    {category: "TW", type: 'verbesIndef', translation: shuffle([...b1VerbesIndef]), text: 'refusée', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-refusee.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-refusee.m4a', sentence: '<p>Ta carte a été <b>refusée</b>.</p>'},
    {category: "TW", type: 'verbesIndef', translation: shuffle([...b1VerbesIndef]), text: 'voler', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-voler.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-voler.m4a', sentence: '<p>- Ça suffit de mettre tes clés là, on va se faire cambrioler.</p><p>- Oui, on va vous <b>voler</b> vos poêles antiadhésives !</p>'},

    {category: "TW", type: 'verbesConjug', translation: shuffle([...b1VerbesConjug]), text: 'ça suffit', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-suffit.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-suffit.m4a', sentence: '<p>Non ! Antoine, elle le refait ! Elle le refait ! Non, <b>ça suffit</b> !</p>'},
    {category: "TW", type: 'verbesConjug', translation: shuffle([...b1VerbesConjug]), text: 'ça sonne', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-sonne.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-sonne.m4a', sentence: '<p>-Ça sonne, <b>ça sonne</b>. C\'est elle !</p><p>- Je lui dis quoi, moi ?</p>'},
    {category: "TW", type: 'verbesConjug', translation: shuffle([...b1VerbesConjug]), text: 'ça se bouffe', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-bouffe.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-bouffe.m4a', sentence: '<p><b>Ça se bouffe</b> pas avec du lait ton truc ?</p>'},
    {category: "TW", type: 'verbesConjug', translation: shuffle([...b1VerbesConjug]), text: 'ta gueule', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-gueule.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-gueule.m4a', sentence: '<p>-<b>Ta gueule</b> ! Changement d\'adresse. Qu\'est-ce que tu veux...</p><p>- Ta gueule !</p>'},
    {category: "TW", type: 'verbesConjug', translation: shuffle([...b1VerbesConjug]), text: 't’inquiète', audioAvecArticle: 'sound/mots-cibles/avec-articles/01-inquiete.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/01-inquiete.m4a', sentence: '<p>-Je vais voir ce qu\'il me reste.</p><p>- Non, c\'est bon, <b>t\'inquiète</b>.</p>'},
];
...
let motsCiblesFilmC = [
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'flou', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-flou.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-flou.m4a', sentence: '<p>Pourquoi j\'arrive pas à rester propre comme toutes ces filles avec leur petit carré <b>flou</b> parfait, leur petit slim noir sans plis...</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'ultime', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-ultime.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-ultime.m4a', sentence: '<p>C\'est ma passion <b>ultime</b>, les boulettes !</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'sale', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-sale.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-sale.m4a', sentence: '<p>Je suis négligée, je suis dégueulasse. Même propre, je fais <b>sale</b>.</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'encore', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-encore.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-encore.m4a', sentence: '<p>Antoine croit <b>encore </b>que tu vas au yoga prénatal ?</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'jamais', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-jamais.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-jamais.m4a', sentence: '<p>Ce sera <b>jamais </b>fini avant l\'arrivée du bébé.</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'car', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-car.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-car.m4a', sentence: '<p>Et t\'attends pas à un cadeau commun <b>car </b>personne a mis sur la cagnotte</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'si', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-si.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-si.m4a', sentence: '<p>T\'es <b>si </b>jolie que j\'en oublie que ton pull est dégueulasse.</p>'},
    {category: "TW", type: 'adjectif&co', translation: shuffle([...c1Adjectifs]), text: 'sauf', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-sauf.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-sauf.m4a', sentence: '<p>- Non, mais... je vois tout <b>sauf</b> quelqu\'un de bidon, moi.</p><p>- T\'es magnifique.</p>'},

    {category: "TW", type: 'nomPl', translation: shuffle([...c1NomPl]), text: 'les boulettes', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-boulettes.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-boulettes.m4a', sentence: '<p>Des sandwichs <b>aux boulettes</b> ? </p><p>– Oui.</p>'},
    {category: "TW", type: 'nomPl', translation: shuffle([...c1NomPl]), text: 'les conneries', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-conneries.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-conneries.m4a', sentence: '<p>- Je comprends rien au texto. Tiens.</p><p>- Envoie pas <b>de conneries</b>. </p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...c1NomSg]), text: 'l\'endroit', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-endroit.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-endroit.m4a', sentence: '<p>On a pas <b>d\'endroit</b> pour faire ton anniversaire.</p>'},

    {category: "TW", type: 'nomSg', translation: shuffle([...c1NomSg]), text: 'la goutte', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-goutte.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-goutte.m4a', sentence: '<p>- Vas-y, la petite touche pro : maïs, donut, <b>goutte</b>, <b>goutte</b>. Terminé.</p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...c1NomSg]), text: 'la crotte', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-crotte.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-crotte.m4a', sentence: '<p>- Il m\'a répondu !</p><p>- Ça dit quoi ? </p><p>- Alien, alien, <b>crotte</b>, bébé.</p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...c1NomSg]), text: 'le pote', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-pote.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-pote.m4a', sentence: '<p>C\'est la <b>pote </b>d\'Elsa qui me l\'a filé pour être dans le perso.</p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...c1NomSg]), text: 'la confiance', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-confiance.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-confiance.m4a', sentence: '<p>- C\'est une surprise ?</p><p>- T\'as <b>confiance</b> en moi?</p>'},
    {category: "TW", type: 'nomSg', translation: shuffle([...c1NomSg]), text: 'le truc', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-truc.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-truc.m4a', sentence: '<p>Vous me cachez <b>un truc</b> ou quoi ?</p>'},

    {category: "TW", type: 'verbesIndef', translation: shuffle([...c1VerbesIndef]), text: 'j’avoue', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-avoue.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-avoue.m4a', sentence: '<p>Bon, OK, <b>j\'avoue</b>. Je venais ici, petit.</p>'},
    {category: "TW", type: 'verbesIndef', translation: shuffle([...c1VerbesIndef]), text: 'tu crois', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-crois.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-crois.m4a', sentence: '<p>- Et le père Noël, c\'est pour dire que t\'es un cadeau du ciel.</p><p>- <b>Tu crois </b>? </p>'},
    {category: "TW", type: 'verbesIndef', translation: shuffle([...c1VerbesIndef]), text: 't’inquiète', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-inquiete.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-inquiete.m4a', sentence: '<p>- Tu m\'en veux pas, hein ? </p><p>- Non, <b>t\'inquiète</b>.</p>'},
    {category: "TW", type: 'verbesIndef', translation: shuffle([...c1VerbesIndef]), text: 'vous cachez', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-cachez.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-cachez.m4a', sentence: '<p>- Qu\'est-ce qui se passe ? Vous êtes trop cheloues ce soir.</p><p>- Vous me <b>cachez</b> un truc ou quoi ?</p>'},
    {category: "TW", type: 'verbesIndef', translation: shuffle([...c1VerbesIndef]), text: 'on s’en fout', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-fout.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-fout.m4a', sentence: '<p><b>On s\'en fout</b> ! Réponds. Sinon, ça fait la meuf qui attend pour répondre.</p>'},

    {category: "TW", type: 'verbesConjug', translation: shuffle([...c1VerbesConjug]), text: 'mentir', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-mentir.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-mentir.m4a', sentence: '<p>C\'est pour savoir si je dois continuer <b>mentir</b> à mon frère sur ton congé.</p>'},
    {category: "TW", type: 'verbesConjug', translation: shuffle([...c1VerbesConjug]), text: 'envoie', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-envoie.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-envoie.m4a', sentence: '<p><b>Envoie</b> juste un texto.</p>'},
    {category: "TW", type: 'verbesConjug', translation: shuffle([...c1VerbesConjug]), text: 'transfère', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-transfere.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-transfere.m4a', sentence: '<p>- Vas-y, la petite touche pro : maïs, donut, goutte, goutte. Terminé. <b>Transfère</b>.</p><p>- Il m\'a répondu !</p>'},
    {category: "TW", type: 'verbesConjug', translation: shuffle([...c1VerbesConjug]), text: 'tué', audioAvecArticle: 'sound/mots-cibles/avec-articles/02-tue.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/02-tue.m4a', sentence: '<p>Le gars qui a <b>tué</b> cette fille rencontrée sur Tinder.  </p>'},
];
...
let motsCiblesFilmD = [
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'sérieux', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-serieux.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-serieux.m4a', sentence: '<p>C\'est <b>sérieux</b> avec son nouveau mec ?</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'curieuse', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-curieuse.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-curieuse.m4a', sentence: '<p>« Passionnément <b>curieuse</b>.» Non, mais la fausse vie. Brangelina de la lose.</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'chiante', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-chiante.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-chiante.m4a', sentence: '<p>Pardon, les meufs. Je suis tellement <b>chiante</b>.</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'prête', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-prete.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-prete.m4a', sentence: '<p>Moi, à ce train-là, je suis pas <b>prête</b> d\'avoir des petits-enfants.</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'maintenant', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-maintenant.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-maintenant.m4a', sentence: '<p>Elle attend la réponse du pute. On fait quoi, <b>maintenant</b> ?</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'tellement', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-tellement.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-tellement.m4a', sentence: '<p>Je comprends pas. Mon plan était <b>tellement</b> ingénieusement génial.</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'rien', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-rien.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-rien.m4a', sentence: '<p>- Ça va pas ?</p><p>- Juste une merde au boulot, <b>rien</b> de...</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'mais', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-mais.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-mais.m4a', sentence: '<p>- Physiquement ?</p><p>- Non, <b>mais</b> aussi au niveau caractère.</p>' },
    {category: "TW", type: 'adjectif&co', translation: shuffle([...d1Adjectifs]), text: 'avec', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-avec.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-avec.m4a', sentence: '<p>- Du codo quoi ?</p><p>- Ben, du cododo. Dormir <b>avec</b> le bébé.</p>' },

    {category: "TW", type: 'nomPl', translation: shuffle([...d1NomPl]), text: 'la poussette', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-poussette.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-poussette.m4a', sentence: '<p>Et merci pour la <b>poussette</b> !</p>' },
    {category: "TW", type: 'nomPl', translation: shuffle([...d1NomPl]), text: 'la plaie', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-plaie.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-plaie.m4a', sentence: '<p>Quelle <b>plaie</b>.</p>' },
    {category: "TW", type: 'nomPl', translation: shuffle([...d1NomPl]), text: 'le taf', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-taf.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-taf.m4a', sentence: '<p>Je vais au <b>taf</b>. </p>' },
    {category: "TW", type: 'nomPl', translation: shuffle([...d1NomPl]), text: 'le cadeau', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-cadeau.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-cadeau.m4a', sentence: '<p><b>Cadeau</b> des parrains. Ça se fait, non ?</p>' },
    {category: "TW", type: 'nomPl', translation: shuffle([...d1NomPl]), text: 'la robe', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-robe.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-robe.m4a', sentence: '<p>Je vais payer pour la <b>robe</b> et pour son haut aussi.</p>' },
    {category: "TW", type: 'nomPl', translation: shuffle([...d1NomPl]), text: 'le boulot', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-boulot.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-boulot.m4a', sentence: '<p>Et, au <b>boulot</b>, eh ben... je me sens complètement inutile.</p>' },

    {category: "TW", type: 'nomSg', translation: shuffle([...d1NomSg]), text: 'les parrains', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-parrains.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-parrains.m4a', sentence: '<p>Cadeau des <b>parrains</b>. Ça se fait, non ?</p>' },
    {category: "TW", type: 'nomSg', translation: shuffle([...d1NomSg]), text: 'les fringues', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-fringues.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-fringues.m4a', sentence: '<p>Bon, vas-y, on y va, je vais te louer des <b>fringues</b>. On va chez moi.</p>' },

    {category: "TW", type: 'verbesIndef', translation: shuffle([...d1VerbesIndef]), text: 'aider', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-aider.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-aider.m4a', sentence: '<p>Je peux vous <b>aider</b> ?</p>' },
    {category: "TW", type: 'verbesIndef', translation: shuffle([...d1VerbesIndef]), text: 'ressembler', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-ressembler.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-ressembler.m4a', sentence: '<p>Je vais <b>ressembler</b> à sa mère.</p>' },
    {category: "TW", type: 'verbesIndef', translation: shuffle([...d1VerbesIndef]), text: 'envoyer', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-envoyer.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-envoyer.m4a', sentence: '<p>Ah ! Peut-être que Jules serait d\'accord pour lui <b>envoyer</b> un message gratos.</p>' },
    {category: "TW", type: 'verbesIndef', translation: shuffle([...d1VerbesIndef]), text: 'attends', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-attends.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-attends.m4a', sentence: '<p>- Elsa, <b>attends</b> !</p><p>- On est désolées.</p>' },
    {category: "TW", type: 'verbesIndef', translation: shuffle([...d1VerbesIndef]), text: 'arrête', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-arrete.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-arrete.m4a', sentence: '<p>- Attends, <b>arrête</b>, Elsa ! </p><p>- Hé, bébé...</p>' },
    {category: "TW", type: 'verbesIndef', translation: shuffle([...d1VerbesIndef]), text: 'désolé', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-desole.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-desole.m4a', sentence: '<p><b>Désolée</b>, on a tout vendu ce matin.</p>' },

    {category: "TW", type: 'verbesConjug', translation: shuffle([...d1VerbesConjug]), text: 'je rembourse', audioAvecArticle: 'sound/mots-cibles/avec-articles/03-rembourse.m4a', audioSansArticle: 'sound/mots-cibles/sans-articles/03-rembourse.m4a', sentence: '<p>- C\'est loin, ton hôtel ? </p><p>- Pour faire un aller-retour. </p><p>- Je te <b>rembourse</b>, t\'inquiète !</p>' },
